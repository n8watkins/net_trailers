                        ...
                        <div className="relative overflow-hidden pt-4">
                            ...
                            <div className="relative z-10 flex flex-col items-center justify-start px-6 pt-8 pb-6">
                                ...
                                <div className="relative mb-4">
                                    ...
                                    <DocumentTextIcon className="relative w-16 h-16 text-blue-400 drop-shadow-[0_0_20px_rgba(59,130,246,0.5)]" />
                                </div>
                                ...
                                <p className="text-base sm:text-lg text-gray-300 mb-6 text-center max-w-2xl">
                                    Version history and release notes for NetTrailer
                                </p>
                            </div>
                        </div>

                        {/* Main Content Area */}
                        <div className="px-6 sm:px-8 lg:px-12 py-8 space-y-8 max-w-5xl mx-auto">
                            {/* Loading State */}
                            {loading && (
