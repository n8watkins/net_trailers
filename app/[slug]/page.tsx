...
import { EyeIcon, PencilIcon, RectangleStackIcon } from '@heroicons/react/24/solid'
...
const CollectionPage = ({ params }: CollectionPageProps) => {
    ...
    // Get the collection ID for localStorage persistence
    const collectionId = selectedList?.id || ''
