    ...
    return (
        <div className="pb-4 sm:pb-6 md:pb-8">
            ...
            <div className="relative row-container h-[17rem] sm:h-[19rem] md:h-[21rem] lg:h-[23rem] xl:h-[28.5rem] group">
                ...
                >
                    <div className="ml-8 bg-black/50 rounded-lg w-14 h-[12rem] sm:h-[14rem] md:h-[16rem] lg:h-[18rem] xl:h-[23.5rem] flex items-center justify-center backdrop-blur-md hover:bg-black/70 transition-colors duration-300 shadow-2xl border border-white/20">
                ...
                >
                    <div className="mr-8 bg-black/50 rounded-lg w-14 h-[12rem] sm:h-[14rem] md:h-[16rem] lg:h-[18rem] xl:h-[23.5rem] flex items-center justify-center backdrop-blur-md hover:bg-black/70 transition-colors duration-300 shadow-2xl border border-white/20">
