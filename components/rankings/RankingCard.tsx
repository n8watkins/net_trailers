...
export function RankingCard({ ranking, showAuthor = true, onLike }: RankingCardProps) {
    ...
    return (
        <div
            ...
            className="group relative bg-zinc-900 rounded-lg overflow-hidden hover:bg-zinc-800 transition-all duration-200 hover:scale-[1.02] cursor-pointer border border-zinc-800 hover:border-zinc-700"
        >
                ...
                <div className="flex items-center justify-between pt-2 border-t border-zinc-800">
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                        ...
                        >
                            ...
                            <span className={isLiked ? 'text-red-500' : ''}>{ranking.likes}</span>
                        </button>
