...
/**
 * Authentication modal. GitHub-only sign-in via Auth.js. Guests can keep using
 * the app without signing in; signing in syncs their data to the cloud.
 */
                    ...
                    <>
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-300">
                                Sign in with GitHub to save your watchlists, rankings, and
                        ...
                        <p className="text-center text-gray-500 text-sm mt-6">
                            You can keep browsing as a guest — your data stays in this browser until
                            you sign in.
                        </p>
                    </>
                )}
