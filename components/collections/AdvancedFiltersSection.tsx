...
export function AdvancedFiltersSection({ filters, onChange }: AdvancedFiltersSectionProps) {
        ...
        switch (e.key) {
            case 'ArrowDown':
                ...
                setSelectedIndex((prev) =>
                    prev < peopleSearchResults.length - 1 ? prev + 1 : prev
                )
                break
            case 'ArrowUp':
                e.preventDefault()
    ...
    return (
        <div className="space-y-6">
            {/* Year Range */}
            <div>
                <label className="block text-sm font-medium text-gray-200 mb-3">Release Year</label>
            ...
            <div>
                <label className="block text-sm font-medium text-gray-200 mb-3">Rating Range</label>
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                updateFilter('ratingMin', parseInt(e.target.value) || undefined)
                            }
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                updateFilter('ratingMax', parseInt(e.target.value) || undefined)
                            }
                            className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-red-600 [&::-webkit-slider-thumb]:cursor-pointer"
                        />
                        <div className="flex justify-between text-xs text-gray-500 mt-1">
                        ...
                        {selectedPeople.map((person) => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p
                                        className={`text-xs ${person.known_for_department === 'Acting' ? 'text-blue-400' : 'text-purple-400'}`}
                                    >
