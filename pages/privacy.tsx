                        ...
                        <div className="space-y-8 text-gray-300">
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 mb-4 space-y-2">
                                    ...
                                    <li>Display name and profile information (from social login providers)</li>
                            ...
                            <section>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h4 className="font-semibold text-white">Firebase (Google)</h4>
                                        <p>Authentication, user data storage, and hosting services</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-white">The Movie Database (TMDB)</h4>
                                        <p>Movie and TV show data, images, and metadata</p>
                                    </div>
                                    <div>
                                        <h4 className="font-semibold text-white">Social Login Providers</h4>
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 space-y-2">
                                    <li><strong>Account Access:</strong> You can view and update your account information at any time</li>
                                    <li><strong>Data Deletion:</strong> You can delete your account and associated data</li>
                                    <li><strong>Marketing Opt-out:</strong> Unsubscribe from promotional communications</li>
                                    <li><strong>Analytics Opt-out:</strong> Use browser settings to disable analytics tracking</li>
                                    <li><strong>Guest Mode:</strong> Use our service without creating an account (limited features)</li>
                                </ul>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="mb-4">
                                    We retain your personal information for as long as necessary to provide our services and fulfill the purposes outlined in this policy. When you delete your account, we will delete your personal information within 30 days, except where we are required to retain it for legal or security purposes.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 space-y-2">
                                    ...
                                    <li>Email: <a href="mailto:privacy@nettrailer.app" className="text-red-400 hover:text-red-300 underline">privacy@nettrailer.app</a></li>
                            ...
                            <section className="border-t border-gray-700 pt-8">
                                ...
                                <ul className="list-disc pl-6 space-y-2">
                                    <li><strong>Performance of Contract:</strong> To provide our services</li>
                            ...
                            <div className="bg-gray-800/50 rounded-lg p-6 mt-8">
                                ...
                                <p className="text-sm text-gray-400">
                                    This policy covers how NetTrailer collects, uses, and protects your personal information when using our movie and TV discovery platform. We use industry-standard security practices and only collect data necessary to provide and improve our services.
                                </p>
                            </div>
                        </div>
                    </div>
