        ...
        <div className="absolute w-screen 2xl:h-[48.8vw] h-screen bg-gradient-to-br  from-black/70 to-black/20 ">
            ...
            >
                <div className="flex flex-col px-10 space-y-4">
                    ...
                    <div className="flex flex-col space-y-3 py-3 border-b border-gray-600/50">
                        <div className="text-center text-sm text-gray-400 mb-2">Quick sign in with</div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            ...
                            <button
                                type="button"
                                className="bg-black hover:bg-gray-900 text-white rounded-md py-3 px-4 font-medium transition-colors flex items-center justify-center space-x-2 border border-gray-600"
                        ...
                        <div className="text-center">
                            <span className="text-xs text-gray-500">Or use email and password</span>
                        </div>
                    </div>
