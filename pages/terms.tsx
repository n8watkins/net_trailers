                    ...
                    <div className="prose prose-lg prose-gray max-w-none">
                        ...
                        <div className="space-y-8 text-gray-300">
                            ...
                            <section>
                                ...
                                <p className="mb-4">
                                    NetTrailer is a movie and TV show discovery platform that allows users to:
                                </p>
                                ...
                                <p className="mb-4">
                                    <strong>Important:</strong> NetTrailer is a discovery platform only. We do not host, stream, or provide access to copyrighted content. All media information is provided by The Movie Database (TMDB) API.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 mb-4 space-y-2">
                                    <li>You may create an account using email/password or social login providers</li>
                                    <li>You are responsible for maintaining the confidentiality of your account credentials</li>
                                    <li>You must provide accurate and complete information</li>
                                    <li>You are responsible for all activities that occur under your account</li>
                                </ul>

                                <h3 className="text-xl font-semibold text-white mb-3">3.2 Guest Access</h3>
                                <p className="mb-4">
                                    You may use our service without creating an account (Guest Mode) with limited functionality. Guest users cannot save favorites or access personalized features.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="mb-4">
                                    You retain ownership of any content you submit (such as favorite lists). By using our service, you grant us a license to store and display this content as necessary to provide our services.
                                </p>

                                <h3 className="text-xl font-semibold text-white mb-3">5.3 Platform Content</h3>
                                <p className="mb-4">
                                    The NetTrailer platform, including its design, code, and original content, is protected by copyright and other intellectual property laws.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <h3 className="text-xl font-semibold text-white mb-3">7.2 Content Accuracy</h3>
                                <p className="mb-4">
                                    While we strive to provide accurate information, we cannot guarantee the accuracy, completeness, or timeliness of movie and TV show data provided by third-party sources.
                                </p>

                                <h3 className="text-xl font-semibold text-white mb-3">7.3 Limitation of Liability</h3>
                                <p className="mb-4">
                                    To the maximum extent permitted by law, NetTrailer shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the service.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 mb-4 space-y-2">
                                    <li><strong>The Movie Database (TMDB):</strong> Content data and images</li>
                                    <li><strong>Google Services:</strong> Authentication and analytics</li>
                                    <li><strong>Discord & Twitter:</strong> Social authentication</li>
                                    <li><strong>YouTube:</strong> Trailer playback</li>
                                </ul>
                                <p className="mb-4">
                            ...
                            <section>
                                ...
                                <h3 className="text-xl font-semibold text-white mb-3">9.1 By You</h3>
                                <p className="mb-4">
                                    You may delete your account at any time. Upon deletion, your personal data will be removed according to our Privacy Policy.
                                </p>

                                <h3 className="text-xl font-semibold text-white mb-3">9.2 By Us</h3>
                                <p className="mb-4">
                                    We reserve the right to suspend or terminate accounts that violate these terms or engage in harmful behavior. We will provide reasonable notice when possible.
                                </p>
                            </section>

                            <section>
                                <h2 className="text-2xl font-semibold text-white mb-4">10. DMCA and Copyright</h2>
                                <p className="mb-4">
                                    We respect intellectual property rights. If you believe your copyrighted work has been infringed, please contact us with:
                                </p>
                                <ul className="list-disc pl-6 mb-4 space-y-2">
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 space-y-2">
                                    <li>Through our support page: <a href="/support" className="text-red-400 hover:text-red-300 underline">/support</a></li>
                                    <li>Email: <a href="mailto:legal@nettrailer.app" className="text-red-400 hover:text-red-300 underline">legal@nettrailer.app</a></li>
                                    <li>GitHub: <a href="https://github.com/n8watkins/net_trailer" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:text-red-300 underline">Project Repository</a></li>
                                </ul>
                            </section>
                            ...
                            <div className="bg-gray-800/50 rounded-lg p-6 mt-8">
                                ...
                                <div className="text-sm text-gray-400 space-y-2">
                                    <p><strong>Discovery Platform:</strong> NetTrailer is for content discovery only - we do not host or stream movies/TV shows.</p>
                                    <p><strong>Guest Access:</strong> You can use our service without creating an account (limited features).</p>
                                    <p><strong>Data Sources:</strong> All content information comes from The Movie Database (TMDB).</p>
                                    <p><strong>Open Source:</strong> This project is open source and available on GitHub.</p>
                                </div>
                            </div>
                        </div>
                    </div>
